            ...
            <div class="new-task__card">
                <div class="new-task__title">
                    ...
                    <a class="new-task__type link-regular" href="#">
                        <p>Здесь будет категория, пока только id <?php echo $task['category_id']; ?></p>
                    </a>
                </div>
                ...
                <p class="new-task__place">Здесь будут адрес, пока id города <?php echo $task['city_id']; ?></p>
                <span class="new-task__time"><?php echo $task['date_create']; ?></span>
            </div> 
        <?php endforeach; ?>
